      ...
      <div className="px-6 pt-12 pb-24 max-w-md mx-auto">
        ...
        <div className="flex justify-end mb-4 relative z-[100]">
          <a
            ...
            className="flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-gray-900 transition-colors uppercase tracking-tight cursor-pointer"
          >
            <LogOut size={16} />
            Log Out
          </a>
        ...
        {/* Stats Row */}
        <div className="grid grid-cols-[1fr_1.1fr] gap-6 mb-8 -ml-[2px]">
          {/* Calorie Ring */}
